...
const defaultInterpreter: string = "scala -cp %CLASSPATH%";
...
function initialiseInteractiveScala() {
	...
	let minterpreter = interpreter+" -cp "+extDir.extensionPath + "\\kdb-studio\\lib\\*.jar";
	interactiveTerminal.sendText(minterpreter, true);
