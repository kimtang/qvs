...
function changeServer(activeTextEditor: vscode.TextEditor) {
	...
	vscode.window.showQuickPick(['aaa','bbb','ccc']).then( selection => console.log(selection));
...
export function activate(context: vscode.ExtensionContext) {
	...
	let interactiveScalaChangeServer = vscode.commands.registerCommand('interactiveScala.changeServer', () => {
		let activeTextEditor = vscode.window.activeTextEditor;
		if(activeTextEditor && activeTextEditor.document.languageId === "q") {
